...
class Expenditure(models.Model):
    ...
    name = models.CharField(max_length=256, verbose_name="Name")
    location = models.CharField(max_length=256, verbose_name="Location", blank=True, null=True)
    ...
    category = models.CharField(max_length=256, default="others", verbose_name="Category")
    attachment = models.CharField(max_length=256, verbose_name="Attachment", blank=True, null=True)
    inserted_at = models.DateTimeField(auto_now_add=True, verbose_name="Inserted At")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Updated At")
